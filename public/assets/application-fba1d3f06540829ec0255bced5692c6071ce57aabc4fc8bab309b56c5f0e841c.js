...
(function() {
  window.Messages = {
    minChatroom: function() {
      $("#chatroom").slideToggle();
      $("#chatBeam").show();
      return false;
    },
    maxChatroom: function() {
      var flash;
      $("#chatBeam").hide();
    ...
    changeSelectionChar: function(elemTag) {
      var editor, editorCharArray, editorText, selectionEnd, selectionStart;
    ...
    constructEmotions: function() {
      var cell, i, img, j, k, l, n, page, row, table;
      ...
      if (!table.has("span").length) {
        for (i = k = 0; k < 10; i = ++k) {
          ...
          for (j = l = 0; l < 8; j = ++l) {
            ...
            img.attr("emotion", "" + n);
            img.css({
              "background": "url(\"/assets/emotions/" + n + ".gif\")"
            });
    ...
    emotionsPageTurning: function() {
      $("span.emotions-page").click(function() {
        if ($(this).html() === "&lt;") {
    ...
    displayAllEmotions: function() {
      Messages.constructEmotions();
      $("table.chatroom-emotions-images").toggle();
      return false;
    },
    selectEmotion: function() {
      var editor, editorCharArray, editorText, imageTag, img, selectionStart;
    ...
    constructColors: function() {
      var colors;
      return colors = ["#FFFFFF", "#000000", "#EEEEC1", "#1F497D", "#4F81BD", "#C0504D", "#9BBB59", "#8064A2", "#4BACC6", "#F79646", "#F2F2F2", "#7F7F7F", "#DDD9C3", "#C6D9F0", "#DBE5F1", "#F2DCDB", "#EBF1DD", "#E5E0DC", "#DBEEF3", "#FDEADA", "#D8D8D8", "#595959", "#C4DB97", "#8DB3E2", "#B8CCE4", "#E5B9B7", "#D7E3BC", "#CCC1D9", "#B7DDE8", "#FBD5b5", "#BFBFBF", "#3F3F3F", "#938953", "#548DD4", "#95B3D7", "#D99694", "#C3D69B", "#B2A27C", "#92CDDC", "#FAC08F", "#A5A5A5", "#262626", "#494429", "#17365D", "#366092", "#953734", "#76923C", "#5F497A", "#31859B", "#E36709", "#7F7F7F", "#0C0C0C", "#1D1D10", "#0F243E", "#244061", "#632423", "#4F6128", "#3F3151", "#205867", "#974806", "#C00000", "#FF0000", "#FFC000", "#FFFF00", "#92D050", "#00B050", "#00B0F0", "#0070C0", "#002060", "#7030A0"];
    },
    constructColorsTab: function() {
      var cell, color, colors, i, j, k, l, n, num, row, table;
      ...
      if (!table.has("span").length) {
        for (i = k = 0; k < 7; i = ++k) {
          ...
          for (j = l = 0; l < 10; j = ++l) {
            ...
            color.css({
              "background-color": "" + (num.attr('color-num'))
            });
  ...
  $(document).ready(function() {
    $(".min-chatroom").click(function() {
      Messages.minChatroom();
      return false;
    });
    $(".max-chatroom").click(function() {
    ...
    return $(".font-colorer").click(function() {
